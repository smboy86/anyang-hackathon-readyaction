        ...
        <ImageBackground source={BG_IMAGE} style={styles.bgImage}>
          <View style={styles.loginView}>
            <View style={styles.loginTitle}>
              <View style={{ justifyContent: "center" }}>
                <Image
                  ...
                  source={LOGIN_IMG}
                />
                <Text style={{ fontSize: 26, color: "#fff" }}>레디액션</Text>
              </View>
            ...
            <Button
              ...
              onPress={this.submitLoginCredentials.bind(this, true)}
              loading={showLoading}
            ...
            <View style={styles.footerView}>
              <Text style={{ color: "grey" }}>처음이세요?</Text>
              <Button
                title="회원가입"
                type="clear"
                activeOpacity={0.5}
